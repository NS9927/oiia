...
- Shadow launcher integration for syncing the current PLS mod load order into a read-only Shadow playset and launching HOI4 from IntelliJ IDEA.
...
## Shadow Workflow
1. Configure the HOI4 game and mod load order in Paradox Language Support.
...
Version 1.0.1 adds project creation and Shadow launch workflows on top of the first stable preview feature set.
## Issue Tracking
